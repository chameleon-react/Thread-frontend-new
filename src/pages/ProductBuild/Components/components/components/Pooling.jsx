...
import {setBoxingPrice} from '../../../../../redux/slice/price'
    ...
    return (
        <>
            <div className="button flex justify-center mt-5 gap-[70%] font-bold">
                ...
                <div className="next">
                    <button className='border w-20  text-white rounded-2xl bg-blue-800  hover:text-blue-800 hover:bg-white duration-300 text-sm font-medium h-7' onClick={() => {setViewDetails(true);dispatch(setBoxingPrice())}}>Next {'>'}</button>
                </div>
            </div>
            ...
            {
                viewDetails &&<ViewDetails setViewDetails={setViewDetails}/>
            }
        </>
    )
}
