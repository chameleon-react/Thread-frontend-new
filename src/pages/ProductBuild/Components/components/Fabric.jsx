  ...
  return (
    <div>
      <div className="flex justify-center font-semibold items-center h-14 gap-28">
        ...
        <button className='border w-20  text-white rounded-2xl bg-blue-800  hover:text-blue-800 hover:bg-white duration-300 text-sm font-medium h-7' onClick={() => setSelected(1)} disabled={disable}>Next {'>'}</button>
      </div>
      <hr />
      ...
      <hr />
      {Selector === 0 && <AllFabrics setdisable={setdisable} />}
